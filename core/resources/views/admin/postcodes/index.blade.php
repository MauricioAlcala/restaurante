                    ...
                    <tbody>
                      @foreach ($postcodes as $key => $postcode)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm editbtn" href="#editModal" data-toggle="modal" data-postcode_id="{{$postcode->id}}" data-title="{{$postcode->title}}" data-postcode="{{$postcode->postcode}}" data-charge="{{$postcode->charge}}" data-serial_number="{{$postcode->serial_number}}">
